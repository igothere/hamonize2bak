package com.center.hamonize.policymngr.mapper;
...
public interface IPcMngrMapper_server {
	...
	//pcBlockStatus
	public PcMangrVo getSgbPcBlockStatus(PcMangrVo vo);
	...
	// ============ Server =============
	public int inserPcInfoInServer(PcMangrVo vo);

	public int inserPcInfoInServerChk(PcMangrVo vo);

	public int updatePcInfoInServer(PcMangrVo vo);
