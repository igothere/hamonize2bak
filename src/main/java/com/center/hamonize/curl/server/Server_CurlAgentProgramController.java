...
import com.mapper.server.IGetAgentProgrmMapper_Server;
import com.model.GetAgentJobVo;
import com.model.GetAgentProgrmVo;

@RestController
@RequestMapping("/getAgentServer")
public class Server_CurlAgentProgramController {

	@Autowired
	private IGetAgentJobMapper_Server agentJobMapper;

	@Autowired
	private IGetAgentProgrmMapper_Server getAgentProgrmMapper;
