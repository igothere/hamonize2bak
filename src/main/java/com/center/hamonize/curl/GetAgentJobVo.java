...
public class GetAgentJobVo {
	...
	public String getSgb_uuid() {
		return sgb_uuid;
	}
	public void setSgb_uuid(String sgb_uuid) {
		this.sgb_uuid = sgb_uuid;
	}
	...
	public String toString() {
		return "GetAgentJobVo [sgb_pc_uuid=" + sgb_pc_uuid + ", seq=" + seq + ", p_seq=" + p_seq + ", org_nm=" + org_nm
				...
				+ ", uuid_orgname=" + uuid_orgname + ", upper_org_seq=" + upper_org_seq + ", sgb_uuid=" + sgb_uuid
				...
				+ ", getUpper_org_seq()=" + getUpper_org_seq() + ", getSgb_uuid()=" + getSgb_uuid()
				...
				+ ", getSgb_pc_uuid()=" + getSgb_pc_uuid() + ", getSeq()=" + getSeq() + ", getP_seq()=" + getP_seq()
